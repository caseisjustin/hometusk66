import { defaultFavorites } from '../models/favorites.js';
let favorites = Object.assign({}, defaultFavorites);
export const getFavorites = () => favorites;
export const addFavoriteArtist = (artistId) => {
...
export const addFavoriteAlbum = (albumId) => {
...
export const addFavoriteTrack = (trackId) => {
...
export const cleanUpFavorites = (entityId) => {
